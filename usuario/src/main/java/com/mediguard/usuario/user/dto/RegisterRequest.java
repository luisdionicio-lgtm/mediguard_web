...
public record RegisterRequest(
                @JsonProperty("first_name") @NotBlank(message = "El nombre es obligatorio.") String firstName,
                @JsonProperty("last_name") @NotBlank(message = "El apellido es obligatorio.") String lastName,
